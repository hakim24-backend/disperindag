...
/**
 * JenisPelayananSearch represents the model behind the search form about `common\models\JenisPelayanan`.
 */
class JenisPelayananSearch extends JenisPelayanan
{
    /**
     * @inheritdoc
     */
